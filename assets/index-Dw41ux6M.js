 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe="WebChannelConnection";class kC extends CC{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,r,i,s){const o=Th();return new Promise((l,u)=>{const h=new Av;h.setWithCredentials(!0),h.listenOnce(Cv.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Ca.NO_ERROR:const p=h.getResponseJson();B(Qe,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case Ca.TIMEOUT:B(Qe,`RPC '${e}' ${o} timed out`),u(new H(L.DEADLINE_EXCEEDED,"Request time out"));break;case Ca.HTTP_ERROR:const m=h.getStatus();if(B(Qe,`RPC '${e}' ${o} failed with status:`,m,"response text:",h.getResponseText()),m>0){let S=h.getResponseJson();Array.isArray(S)&&(S=S[0]);const R=S==null?void 0:S.error;if(R&&R.status&&R.message){const D=function(I){const _=I.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(_)>=0?_:L.UNKNOWN}(R.status);u(new H(D,R.message))}else u(new H(L.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new H(L.UNAVAILABLE,"Connection failed."));break;default:q(9055,{l_:e,streamId:o,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{B(Qe,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(i);B(Qe,`RPC '${e}' ${o} sending request:`,i),h.send(n,"POST",f,r,15)})}T_(e,n,r){const i=Th(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Pv(),l=kv(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Ho(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const f=s.join("");B(Qe,`Creating RPC '${e}' stream ${i}: ${f}`,u);const p=o.createWebChannel(f,u);let m=!1,S=!1;const R=new RC({Zo:O=>{S?B(Qe,`Not sending because RPC '${e}' stream ${i} is closed:`,O):(m||(B(Qe,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),B(Qe,`RPC '${e}' stream ${i} sending:`,O),p.send(O))},Xo:()=>p.close()}),D=(O,I,_)=>{O.listen(I,A=>{try{_(A)}catch(x){setTimeout(()=>{throw x},0)}})};return D(p,ws.EventType.OPEN,()=>{S||(B(Qe,`RPC '${e}' stream ${i} transport opened.`),R.__())}),D(p,ws.EventType.CLOSE,()=>{S||(S=!0,B(Qe,`RPC '${e}' stream ${i} transport closed`),R.u_())}),D(p,ws.EventType.ERROR,O=>{S||(S=!0,Vi(Qe,`RPC '${e}' stream ${i} transport errored. Name:`,O.name,"Message:",O.message),R.u_(new H(L.UNAVAILABLE,"The operation could not be completed")))}),D(p,ws.EventType.MESSAGE,O=>{var I;if(!S){const _=O.data[0];ae(!!_,16349);const A=_,x=(A==null?void 0:A.error)||((I=A[0])===null||I===void 0?void 0:I.error);if(x){B(Qe,`RPC '${e}' stream ${i} received error:`,x);const U=x.status;let b=function(v){const w=Ce[v];if(w!==void 0)return uE(w)}(U),E=x.message;b===void 0&&(b=L.INTERNAL,E="Unknown error status: "+U+" with message "+x.message),S=!0,R.u_(new H(b,E)),p.close()}else B(Qe,`RPC '${e}' stream ${i} received:`,_),R.c_(_)}}),D(l,Rv.STAT_EVENT,O=>{O.stat===ch.PROXY?B(Qe,`RPC '${e}' stream ${i} detected buffering proxy`):O.stat===ch.NOPROXY&&B(Qe,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{R.a_()},0),R}}function uc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Va(t,e,n){return`firebase:${t}:${e}:${n}`}class Ii{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Va(this.userKey,i.apiKey,s),this.fullPersistenceKey=Va("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await wl(this.auth,{idToken:e}).catch(()=>{});return n?Ft._fromGetAccountInfoResponse(this.auth,n,e):null}return Ft._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new Ii(pn(Og),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||pn(Og);const o=Va(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){let p;if(typeof f=="string"){const m=await wl(e,{idToken:f}).catch(()=>{});if(!m)break;p=await Ft._fromGetAccountInfoResponse(e,m,f)}else p=Ft._fromJSON(e,f);h!==s&&(l=p),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new Ii(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new Ii(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
이 작업은 취소할 수 없습니다.`)&&e()},f=p=>{p&&confirm("📥 선택한 파일의 단어를 기존 데이터와 병합하시겠습니까?")&&r(p)};return j.jsxs("div",{className:"settings-panel",children:[j.jsx("h2",{children:"Settings"}),j.jsx("button",{onClick:i,className:"settings-button",children:l?"🌞 Light Mode":"🌙 Dark Mode"}),j.jsx("button",{onClick:s,className:"settings-button",children:o==="en"?"🇰🇷 한국어":"🇺🇸 English"}),j.jsx("button",{onClick:u,className:"settings-button",children:"💾 Backup"}),j.jsx("button",{onClick:h,className:"settings-button",children:"♻️ Restore"}),j.jsx("button",{onClick:n,className:"settings-button",children:"📤 Export"}),j.jsxs("label",{className:"import-label settings-button",children:[" ","📥 Import",j.jsx("input",{type:"file",accept:"application/json",style:{display:"none"},onChange:p=>f(p.target.files[0])})]})]})}function ZP({auth:t,db:e,setUser:n,setWords:r}){oe.useEffect(()=>{const i=Rk(t,async s=>{if(n(s),!!s)try{const o=await ow(GE(e,"users",s.uid,"words")),l={};o.forEach(f=>{const p=f.data();p!=null&&p.lastReviewedAt&&(l[f.id]=p)});const u=JSON.parse(localStorage.getItem("wordData")||"{}"),h={...l};for(const[f,p]of Object.entries(u)){const m=l[f];if(!p||typeof p!="object")continue;const S=new Date(p.lastReviewedAt||"2000-01-01"),R=new Date((m==null?void 0:m.lastReviewedAt)||"2000-01-01");(!m||S>R)&&(h[f]=p)}r(h),localStorage.setItem("wordData",JSON.stringify(h)),console.log("🔁 자동 복원 병합 완료")}catch(o){console.error("❌ 자동 복원 중 오류:",o)}});return()=>i()},[t,e,n,r])}const Xg=()=>new Date().toLocaleDateString("en-CA"),e2=t=>{const e=new Date().toLocaleDateString("en-CA"),n=new Date(t).toLocaleDateString("en-CA"),r=new Date(e),i=new Date(n),s=r.getTime()-i.getTime();return Math.floor(s/(1e3*60*60*24))};function t2({words:t,setWords:e,user:n,db:r,skipNextSaveRef:i}){return{addWord:(u,h,f)=>{const p=u.toLowerCase().trim();if(!p)return;const m=Xg(),S=t[p],R={...t};S?R[p]={...S,lastReviewedAt:m}:R[p]={count:0,lastReviewedAt:m,reviewedSources:[],createdAt:m},e(R),h(p),f(1),localStorage.setItem("wordData",JSON.stringify(R)),i.current=!0},handleReview:(u,h)=>{const f=Xg(),p=t[u];if(!p)return;const m=p.lastReviewedAt===f,S=Array.isArray(p.reviewedSources)?p.reviewedSources:[],R=m&&S.includes(h);if(R)return;const D=m?[...new Set([...S,h])]:[h],O={...p,count:m&&S.length>0&&!R?p.count:p.count+1,lastReviewedAt:f,reviewedSources:D};if(!(O.count!==p.count||O.lastReviewedAt!==p.lastReviewedAt))return;const _={...t,[u]:O};e(_),localStorage.setItem("wordData",JSON.stringify(_)),i.current=!0},deleteWord:u=>{const h={...t};delete h[u],e(h),localStorage.setItem("wordData",JSON.stringify(h)),i.current=!0}}}const n2=t=>`wordSnapshot_${t}`;async function r2(t,e,{silent:n=!0}={}){if(!t||!e)return;const r=n2(t),i=JSON.stringify(e),s=localStorage.getItem(r);if(s===i){n||alert("✅ 변경된 항목이 없어 저장할 필요가 없습니다.");return}const o=s?JSON.parse(s):{},l=Object.entries(e).filter(([h,f])=>JSON.stringify(f)!==JSON.stringify(o[h])),u=l.map(([h,f])=>aw(Yd(Nr,"users",t,"words",h),f));try{await Promise.all(u),localStorage.setItem(r,i),n||alert(`✅ 백업 완료: ${l.length}개 항목 저장됨`)}catch(h){console.error("❌ 백업 실패:",h),alert("❌ 백업 중 오류가 발생했습니다.")}}async function i2(t,e,n){try{const r=`wordSnapshot_${t}`,i=await ow(GE(e,"users",t,"words")),s={};i.forEach(u=>{const h=u.data();h&&h.lastReviewedAt&&(s[u.id]=h)});let o={};try{o=JSON.parse(localStorage.getItem(r)||"{}")}catch(u){console.warn("⚠️ localStorage JSON 파싱 실패. Firestore 데이터만 사용:",u)}const l={...s};for(const[u,h]of Object.entries(o)){const f=s[u];if(!h||typeof h!="object")continue;const p=new Date(h.lastReviewedAt||"2000-01-01"),m=new Date((f==null?void 0:f.lastReviewedAt)||"2000-01-01");(!f||p>m)&&(l[u]=h)}try{localStorage.setItem(r,JSON.stringify(l))}catch(u){console.warn("⚠️ localStorage 저장 실패. 병합은 성공했지만 로컬 저장 실패:",u)}typeof n=="function"?n(l):console.error("⚠️ setWords is not a function:",n)}catch(r){console.error("❌ restoreFromFirestoreWithMerge 실패:",r),console.error("⚠️ 병합 복원 중 오류가 발생했습니다.")}}function s2(t,e){let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>t(...r),e)}}function o2({user:t,words:e,inputWord:n,darkMode:r,setWords:i,setSaveStatus:s,setIsRestoring:o,skipNextSaveRef:l,setBackupError:u}){const h=oe.useRef(Date.now());oe.useEffect(()=>{document.body.classList.toggle("dark-mode",r),localStorage.setItem("darkMode",r)},[r]),oe.useEffect(()=>{const p=t==null?void 0:t.uid;if(!p)return;const m=`wordSnapshot_${p}`;localStorage.getItem("wordData")&&!localStorage.getItem(m)&&localStorage.setItem(m,localStorage.getItem("wordData"));try{const S=JSON.parse(localStorage.getItem(m))||{};i(S)}catch(S){console.error("❌ localStorage 복원 실패:",S),i({})}},[t]),oe.useEffect(()=>{t&&e&&(h.current=Date.now())},[t,e]);const f=oe.useRef(s2(async()=>{const p=t==null?void 0:t.uid;if(p)try{await r2(p,e),s(""),u&&u(!1)}catch(m){console.error("❌ 저장 실패:",m);const S=(m==null?void 0:m.message)||"",R=(m==null?void 0:m.code)||"";S.includes("quota")||R==="resource-exhausted"?(console.warn("⚠️ Firestore quota exceeded. 자동 저장 중단"),u&&u(!0),s("⏸️ 저장이 중단되었습니다. Firebase 일일 사용량 초과로 인해 30분 후 자동 재시도됩니다."),setTimeout(()=>{u&&u(!1),s("")},30*60*1e3)):s("⚠️ 저장 실패")}},5e3)).current;oe.useEffect(()=>{if(!(!t||!e)){if(l.current){l.current=!1;return}f()}},[t,e]),oe.useEffect(()=>{const p=async()=>{if(document.visibilityState==="visible"&&t&&n.length===0){if(Date.now()-h.current<3e3){console.log("🛑 최근 단어 변경으로 인해 복원 생략");return}const S=t==null?void 0:t.uid;if(!S)return;try{o(!0),await i2(S,Nr,i),l.current=!0,console.log("🔁 복원 완료, 자동 저장 1회 생략")}catch(R){console.error("❌ 복원 실패:",R)}finally{setTimeout(()=>o(!1),500)}}};return document.addEventListener("visibilitychange",p),()=>document.removeEventListener("visibilitychange",p)},[t,n])}function a2(){const[t,e]=oe.useState(!1),n=oe.useRef(null),r=oe.useRef(null),i=()=>e(s=>!s);return oe.useEffect(()=>{if(!t)return;function s(o){n.current&&!n.current.contains(o.target)&&r.current&&!r.current.contains(o.target)&&e(!1)}return document.addEventListener("mousedown",s),()=>{document.removeEventListener("mousedown",s)}},[t]),{showSettings:t,toggleSettings:i,settingsRef:n,settingsButtonRef:r}}function l2(t,e,n){const r=Object.entries(t).filter(([i])=>i!==n).sort(([i,s],[o,l])=>{switch(e){case"abcAsc":return i.localeCompare(o);case"abcDesc":return o.localeCompare(i);case"countDesc":return l.count-s.count||i.localeCompare(o);case"dateAsc":return new Date(s.lastReviewedAt)-new Date(l.lastReviewedAt)||i.localeCompare(o);case"dateDesc":return new Date(l.lastReviewedAt)-new Date(s.lastReviewedAt)||i.localeCompare(o);default:return s.count-l.count||i.localeCompare(o)}});return n&&t[n]?[[n,t[n]],...r]:r}function u2(t,e,n){const r=(e-1)*n,i=e*n;return t.slice(r,i)}async function c2(t,e){if(!t||!e)return;const n=Yd(Nr,"users",t);try{await aw(n,{words:e},{merge:!0}),console.log("✅ 수동 백업 완료")}catch(r){console.error("❌ 수동 백업 실패:",r),alert("❌ 클라우드에 백업하는 데 실패했습니다.")}}async function h2(t){if(!t)return null;const e=Yd(Nr,"users",t);try{const n=await bR(e);if(n.exists()){const r=n.data();if(r.words&&typeof r.words=="object")return console.log("✅ 수동 복원 완료"),r.words}return alert("📭 복원할 데이터가 없습니다."),null}catch(n){return console.error("❌ 수동 복원 실패:",n),alert("❌ 클라우드에서 복원하는 데 실패했습니다."),null}}function d2(t){const e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),r=document.createElement("a");r.href=n,r.download=`EchoWord-export-${new Date().toISOString().slice(0,10)}.json`,r.click(),URL.revokeObjectURL(n)}async function f2(t){return new Promise((e,n)=>{const r=new FileReader;r.onload=()=>{try{const i=JSON.parse(r.result);typeof i=="object"?e(i):n(new Error("❌ JSON 구조가 올바르지 않습니다."))}catch(i){n(i)}},r.onerror=()=>n(r.error),r.readAsText(t)})}function p2({user:t,words:e,setWords:n}){return{handleBackup:async()=>{t&&(await c2(t.uid,e),alert("✅ 백업이 완료되었습니다."))},handleRestore:async()=>{if(!t)return;const l=await h2(t.uid);l&&(n(l),alert("✅ 복원이 완료되었습니다. 새로고침합니다."),setTimeout(()=>window.location.reload(),800))},handleExport:()=>{d2(e)},handleImport:async l=>{if(!l)return;const u=await f2(l);u&&(n(h=>({...h,...u})),alert("✅ 병합 완료"))}}}const _r={ko:{title:"EchoWord",totalWords:t=>`총 ${t}단어`,inputPlaceholder:"단어를 입력하세요...",login:"로그인",logout:"로그아웃",backup:"백업",restore:"복원",sortABC:"A–Z",sortCount:"횟수",sortDate:"학습일",studies:t=>`학습 횟수: ${t}`,lastReviewedLabel:"학습일",lastStudied:t=>t===0?"오늘":`${t}일 전`,dictionary:"사전",pronunciation:"발음",studyDone:"학습 완료",delete:"삭제",confirmDelete:"정말 삭제하시겠습니까?",backupSuccess:"✅ 백업 완료!",prev:"이전",next:"다음",page:(t,e)=>`페이지 ${t} / ${e}`,version:t=>`버전: ${t}`,darkModeOn:"다크모드",darkModeOff:"라이트모드"},en:{title:"EchoWord",totalWords:t=>`${t} words`,inputPlaceholder:"Enter a word...",login:"Sign In",logout:"Sign Out",backup:"Backup",restore:"Restore",sortABC:"A–Z",sortCount:"Studied",sortDate:"Reviewed",studies:t=>`Studied: ${t} times`,lastReviewedLabel:"Last reviewed",lastStudied:t=>t===0?"Today":`${t} days ago`,dictionary:"Dictionary",pronunciation:"Pronunciation",studyDone:"Mark Studied",delete:"Delete",confirmDelete:"Are you sure you want to delete this word?",backupSuccess:"✅ Backup complete!",prev:"← Prev",next:"Next →",page:(t,e)=>`Page ${t} of ${e}`,version:t=>`Version: ${t}`,darkModeOn:"Dark Mode",darkModeOff:"Light Mode"}};function m2(){const[t,e]=oe.useState({}),[n,r]=oe.useState(""),[i,s]=oe.useState(null),[o,l]=oe.useState("countAsc"),[u,h]=oe.useState(1),[f,p]=oe.useState(()=>localStorage.getItem("lang")||"ko"),[m,S]=oe.useState(()=>localStorage.getItem("darkMode")==="true"),[R,D]=oe.useState(null),[O,I]=oe.useState(""),[_,A]=oe.useState(!1),[x,U]=oe.useState(!1),b=30,E=oe.useRef(!1),{showSettings:y,toggleSettings:v,settingsRef:w,settingsButtonRef:C}=a2();ZP({auth:Gg,db:Nr,setUser:s,setWords:e});const{addWord:k,handleReview:T,deleteWord:at}=t2({words:t,setWords:e,user:i,db:Nr,skipNextSaveRef:E});o2({user:i,words:t,inputWord:n,darkMode:m,setWords:e,setSaveStatus:I,setIsRestoring:A,skipNextSaveRef:E,setBackupError:U});const{handleBackup:$t,handleRestore:kn,handleExport:It,handleImport:z}=p2({user:i,words:t,setWords:e}),K=l2(t,o,R),Y=u2(K,u,b),ce=Math.ceil(K.length/b),se=()=>{const Ve=!m;S(Ve),localStorage.setItem("darkMode",Ve),document.body.classList.toggle("dark-mode",Ve)},me=()=>{const Ve=f==="en"?"ko":"en";p(Ve),localStorage.setItem("lang",Ve)};return j.jsxs("div",{className:"container",style:{padding:"1rem",fontFamily:"Arial"},children:[(_||x)&&j.jsx("div",{className:`progress-bar ${x?"error":""}`}),j.jsx(HP,{wordCount:Object.keys(t).length,onBackup:$t,onRestore:kn,onExport:It,onImport:z,toggleDarkMode:se,toggleLang:me,lang:f,darkMode:m,onToggleSettings:v,settingsButtonRef:C}),j.jsxs("div",{className:"top-group fixed-width-section",children:[j.jsx("div",{className:"row",children:j.jsx(WP,{user:i,setUser:s,auth:Gg,provider:$P,db:Nr,words:t,setWords:e,t:_r,lang:f})}),j.jsx(qP,{sortMode:o,setSortMode:l,lang:f,t:_r})]}),j.jsx(Qg,{totalPages:ce,page:u,setPage:h,t:_r[f],className:"fixed-width-section"}),j.jsx("div",{className:"fixed-width-section",children:j.jsx(GP,{inputWord:n,setInputWord:r,onAddWord:Ve=>k(Ve,D,h),placeholder:_r[f].inputPlaceholder})}),j.jsx("div",{className:"fixed-width-section",children:j.jsx(XP,{words:Y,lang:f,t:_r,getDaysSince:e2,onReview:T,onDelete:at})}),j.jsx(Qg,{totalPages:ce,page:u,setPage:h,t:_r[f],className:"fixed-width-section"}),O&&j.jsx("div",{style:{textAlign:"center",color:"#888",marginTop:"0.5rem"},children:O}),j.jsx("div",{style:{marginTop:"2rem",fontSize:"0.8rem",color:"#888",textAlign:"center"},children:_r[f].version("v1.1.115")}),y&&j.jsx("div",{ref:w,style:{position:"absolute",right:"1rem",top:"3rem",zIndex:1e3},children:j.jsx(JP,{onBackup:$t,onRestore:kn,onExport:It,onImport:z,toggleDarkMode:se,toggleLang:me,lang:f,darkMode:m})}),j.jsx(YP,{})]})}uv(document.getElementById("root")).render(j.jsx(oe.StrictMode,{children:j.jsx(m2,{})}));

 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,K){var X=z.length;z.push(K);e:for(;0<X;){var pe=X-1>>>1,ae=z[pe];if(0<i(ae,K))z[pe]=K,z[X]=ae,X=pe;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var K=z[0],X=z.pop();if(X!==K){z[0]=X;e:for(var pe=0,ae=z.length,Te=ae>>>1;pe<Te;){var tn=2*(pe+1)-1,nn=z[tn],rn=tn+1,sn=z[rn];if(0>i(nn,X))rn<ae&&0>i(sn,nn)?(z[pe]=sn,z[rn]=X,pe=rn):(z[pe]=nn,z[tn]=X,pe=tn);else if(rn<ae&&0>i(sn,X))z[pe]=sn,z[rn]=X,pe=rn;else break e}}return K}function i(z,K){var X=z.sortIndex-K.sortIndex;return X!==0?X:z.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,y=3,S=!1,k=!1,V=!1,L=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,E=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(z){for(var K=n(h);K!==null;){if(K.callback===null)r(h);else if(K.startTime<=z)r(h),K.sortIndex=K.expirationTime,e(u,K);else break;K=n(h)}}function x(z){if(V=!1,A(z),!k)if(n(u)!==null)k=!0,Wi(F);else{var K=n(h);K!==null&&en(x,K.startTime-z)}}function F(z,K){k=!1,V&&(V=!1,I(m),m=-1),S=!0;var X=y;try{for(A(K),g=n(u);g!==null&&(!(g.expirationTime>K)||z&&!C());){var pe=g.callback;if(typeof pe=="function"){g.callback=null,y=g.priorityLevel;var ae=pe(g.expirationTime<=K);K=t.unstable_now(),typeof ae=="function"?g.callback=ae:g===n(u)&&r(u),A(K)}else r(u);g=n(u)}if(g!==null)var Te=!0;else{var tn=n(h);tn!==null&&en(x,tn.startTime-K),Te=!1}return Te}finally{g=null,y=X,S=!1}}var N=!1,_=null,m=-1,v=5,w=-1;function C(){return!(t.unstable_now()-w<v)}function R(){if(_!==null){var z=t.unstable_now();w=z;var K=!0;try{K=_(!0,z)}finally{K?T():(N=!1,_=null)}}else N=!1}var T;if(typeof E=="function")T=function(){E(R)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,zt=st.port2;st.port1.onmessage=R,T=function(){zt.postMessage(null)}}else T=function(){L(R,0)};function Wi(z){_=z,N||(N=!0,T())}function en(z,K){m=L(function(){z(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){k||S||(k=!0,Wi(F))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):v=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return y},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(y){case 1:case 2:case 3:var K=3;break;default:K=y}var X=y;y=K;try{return z()}finally{y=X}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,K){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var X=y;y=z;try{return K()}finally{y=X}},t.unstable_scheduleCallback=function(z,K,X){var pe=t.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?pe+X:pe):X=pe,z){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=X+ae,z={id:f++,callback:K,priorityLevel:z,startTime:X,expirationTime:ae,sortIndex:-1},X>pe?(z.sortIndex=X,e(h,z),n(u)===null&&z===n(h)&&(V?(I(m),m=-1):V=!0,en(x,X-pe))):(z.sortIndex=ae,e(u,z),k||S||(k=!0,Wi(F))),z},t.unstable_shouldYield=C,t.unstable_wrapCallback=function(z){var K=y;return function(){var X=y;y=K;try{return z.apply(this,arguments)}finally{y=X}}}})(iy);ry.exports=iy;var w0=ry.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Or=new yd("@firebase/firestore");function Gr(){return Or.logLevel}function j(t,...e){if(Or.logLevel<=ee.DEBUG){const n=e.map(Ed);Or.debug(`Firestore (${zi}): ${t}`,...n)}}function Tn(t,...e){if(Or.logLevel<=ee.ERROR){const n=e.map(Ed);Or.error(`Firestore (${zi}): ${t}`,...n)}}function Pi(t,...e){if(Or.logLevel<=ee.WARN){const n=e.map(Ed);Or.warn(`Firestore (${zi}): ${t}`,...n)}}function Ed(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QS=new _e(H.comparator);function In(){return QS}const qv=new _e(H.comparator);function _s(...t){let e=qv;for(const n of t)e=e.insert(n.key,n);return e}function Kv(t){let e=qv;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Tr(){return Vs()}function Gv(){return Vs()}function Vs(){return new zr(t=>t.toString(),(t,e)=>t.isEqual(e))}const XS=new _e(H.comparator),YS=new De(H.comparator);function te(...t){let e=YS;for(const n of t)e=e.add(n);return e}const JS=new De(Y);function ZS(){return JS}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kl{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,_o.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Kl(G.min(),i,new _e(Y),In(),te())}}class _o{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new _o(r,n,te(),te(),te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JA{constructor(){this.Vs=!1,this.fs=!1,this.gs=100,this.ps=function(){return WI()?8:AS(Je())>0?6:4}()}initialize(e,n){this.ys=e,this.indexManager=n,this.Vs=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.ws(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Ss(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new YA;return this.bs(e,n,o).next(l=>{if(s.result=l,this.fs)return this.Ds(e,n,o,l.size)})}).next(()=>s.result)}Ds(e,n,r,i){return r.documentReadCount<this.gs?(Gr()<=ee.DEBUG&&j("QueryEngine","SDK will not create cache indexes for query:",Qr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.gs,"documents"),O.resolve()):(Gr()<=ee.DEBUG&&j("QueryEngine","Query:",Qr(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ps*i?(Gr()<=ee.DEBUG&&j("QueryEngine","The SDK decides to create cache indexes for query:",Qr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Gt(n))):O.resolve())}ws(e,n){if(Km(n))return O.resolve(null);let r=Gt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=ch(n,null,"F"),r=Gt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=te(...s);return this.ys.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.vs(n,l);return this.Cs(n,h,o,u.readTime)?this.ws(e,ch(n,null,"F")):this.Fs(e,h,n,u)}))})))}Ss(e,n,r,i){return Km(n)||i.isEqual(G.min())?O.resolve(null):this.ys.getDocuments(e,r).next(s=>{const o=this.vs(n,s);return this.Cs(n,o,r,i)?O.resolve(null):(Gr()<=ee.DEBUG&&j("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Qr(n)),this.Fs(e,o,n,ES(i,Zs)).next(l=>l))})}vs(e,n){let r=new De(Wv(e));return n.forEach((i,s)=>{Hl(e,s)&&(r=r.add(s))}),r}Cs(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}bs(e,n,r){return Gr()<=ee.DEBUG&&j("QueryEngine","Using full collection scan to execute query:",Qr(n)),this.ys.getDocumentsMatchingQuery(e,n,rr.min(),r)}Fs(e,n,r,i){return this.ys.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ke="WebChannelConnection";class fC extends hC{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,r,i,s){const o=gh();return new Promise((l,u)=>{const h=new vv;h.setWithCredentials(!0),h.listenOnce(Ev.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Ia.NO_ERROR:const g=h.getResponseJson();j(Ke,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(g)),l(g);break;case Ia.TIMEOUT:j(Ke,`RPC '${e}' ${o} timed out`),u(new $(M.DEADLINE_EXCEEDED,"Request time out"));break;case Ia.HTTP_ERROR:const y=h.getStatus();if(j(Ke,`RPC '${e}' ${o} failed with status:`,y,"response text:",h.getResponseText()),y>0){let S=h.getResponseJson();Array.isArray(S)&&(S=S[0]);const k=S==null?void 0:S.error;if(k&&k.status&&k.message){const V=function(I){const E=I.toLowerCase().replace(/_/g,"-");return Object.values(M).indexOf(E)>=0?E:M.UNKNOWN}(k.status);u(new $(V,k.message))}else u(new $(M.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new $(M.UNAVAILABLE,"Connection failed."));break;default:W(9055,{l_:e,streamId:o,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{j(Ke,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(i);j(Ke,`RPC '${e}' ${o} sending request:`,i),h.send(n,"POST",f,r,15)})}T_(e,n,r){const i=gh(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Iv(),l=Tv(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Ho(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const f=s.join("");j(Ke,`Creating RPC '${e}' stream ${i}: ${f}`,u);const g=o.createWebChannel(f,u);let y=!1,S=!1;const k=new dC({Zo:L=>{S?j(Ke,`Not sending because RPC '${e}' stream ${i} is closed:`,L):(y||(j(Ke,`Opening RPC '${e}' stream ${i} transport.`),g.open(),y=!0),j(Ke,`RPC '${e}' stream ${i} sending:`,L),g.send(L))},Xo:()=>g.close()}),V=(L,I,E)=>{L.listen(I,A=>{try{E(A)}catch(x){setTimeout(()=>{throw x},0)}})};return V(g,ys.EventType.OPEN,()=>{S||(j(Ke,`RPC '${e}' stream ${i} transport opened.`),k.__())}),V(g,ys.EventType.CLOSE,()=>{S||(S=!0,j(Ke,`RPC '${e}' stream ${i} transport closed`),k.u_())}),V(g,ys.EventType.ERROR,L=>{S||(S=!0,Pi(Ke,`RPC '${e}' stream ${i} transport errored. Name:`,L.name,"Message:",L.message),k.u_(new $(M.UNAVAILABLE,"The operation could not be completed")))}),V(g,ys.EventType.MESSAGE,L=>{var I;if(!S){const E=L.data[0];se(!!E,16349);const A=E,x=(A==null?void 0:A.error)||((I=A[0])===null||I===void 0?void 0:I.error);if(x){j(Ke,`RPC '${e}' stream ${i} received error:`,x);const F=x.status;let N=function(v){const w=Ae[v];if(w!==void 0)return rE(w)}(F),_=x.message;N===void 0&&(N=M.INTERNAL,_="Unknown error status: "+F+" with message "+x.message),S=!0,k.u_(new $(N,_)),g.close()}else j(Ke,`RPC '${e}' stream ${i} received:`,E),k.c_(E)}}),V(l,wv.STAT_EVENT,L=>{L.stat===ih.PROXY?j(Ke,`RPC '${e}' stream ${i} detected buffering proxy`):L.stat===ih.NOPROXY&&j(Ke,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{k.a_()},0),k}}function nc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gl=new yd("@firebase/auth");function VR(t,...e){gl.logLevel<=ee.WARN&&gl.warn(`Auth (${Ui}): ${t}`,...e)}function Pa(t,...e){gl.logLevel<=ee.ERROR&&gl.error(`Auth (${Ui}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rk=5*60,Pk=uv("authIdTokenMaxAge")||Rk;let Bg=null;const kk=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Pk)return;const i=n==null?void 0:n.token;Bg!==i&&(Bg=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Nk(t=mv()){const e=vd(t,"auth");if(e.isInitialized())return e.getImmediate();const n=aP(t,{popupRedirectResolver:Ik,persistence:[OP,TP,mw]}),r=uv("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=kk(s.toString());yP(n,o,()=>o(n.currentUser)),gP(n,l=>o(l))}}const i=av("auth");return i&&uP(n,`http://${i}`),n}function Dk(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}rP({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=Ft("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",Dk().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ck("Browser");function $g({page:t,totalPages:e,onPageChange:n,t:r}){return J.jsxs("div",{className:"pagination-controls",children:[J.jsx("button",{onClick:()=>n(Math.max(1,t-1)),disabled:t===1,children:r.prev}),J.jsx("span",{children:r.page(t,e)}),J.jsx("button",{onClick:()=>n(Math.min(e,t+1)),disabled:t===e,children:r.next})]})}const Vk={apiKey:"AIzaSyCS2cdIvwE8RuZXdAgCL-QE6tAYobYeixw",authDomain:"word-practice-app.firebaseapp.com",projectId:"word-practice-app",storageBucket:"word-practice-app.firebasestorage.app",messagingSenderId:"489669791875",appId:"1:489669791875:web:45291b0005ac5913068bb6"},xk=pv(Vk),Hg=hR(xk),oc=Nk(),Ok=new cn;function Lk(){const[t,e]=$t.useState({}),[n,r]=$t.useState(""),[i,s]=$t.useState(null),[o,l]=$t.useState("countAsc"),[u,h]=$t.useState(1),[f,g]=$t.useState(()=>localStorage.getItem("lang")||"ko"),y=30,S={ko:{title:"EchoWord",totalWords:N=>`총 ${N}단어`,inputPlaceholder:"단어를 입력하세요...",login:"로그인",logout:"로그아웃",backup:"백업",restore:"복원",sortABC:"ABC 정렬",sortCount:"학습횟수 정렬",studies:N=>`학습 횟수: ${N}`,lastReviewedLabel:"학습일",lastStudied:N=>N===0?"오늘":`${N}일 전`,dictionary:"사전",pronunciation:"발음",studyDone:"학습 완료",delete:"삭제",confirmDelete:"정말 삭제하시겠습니까?",backupSuccess:"✅ 백업 완료!",prev:"이전",next:"다음",page:(N,_)=>`페이지 ${N} / ${_}`,version:N=>`버전: ${N}`},en:{title:"EchoWord",totalWords:N=>`${N} words`,inputPlaceholder:"Enter a word...",login:"Sign In",logout:"Sign Out",backup:"Backup",restore:"Restore",sortABC:"Sort: A–Z",sortCount:"Sort: Study Count",studies:N=>`Studied: ${N} times`,lastReviewedLabel:"Last reviewed",lastStudied:N=>N===0?"Today":`${N} days ago`,dictionary:"Dictionary",pronunciation:"Pronunciation",studyDone:"Mark Studied",delete:"Delete",confirmDelete:"Are you sure you want to delete this word?",backupSuccess:"✅ Backup complete!",prev:"← Prev",next:"Next →",page:(N,_)=>`Page ${N} of ${_}`,version:N=>`Version: ${N}`}};$t.useEffect(()=>{const N=JSON.parse(localStorage.getItem("wordData"))||{};e(N),_P(oc,_=>s(_))},[]);const k=()=>new Date().toLocaleDateString("en-CA"),V=N=>{const _=new Date().toLocaleDateString("en-CA"),m=new Date(N).toLocaleDateString("en-CA"),v=new Date(_),w=new Date(m),C=v.getTime()-w.getTime();return Math.floor(C/(1e3*60*60*24))},L=N=>{const _=N.toLowerCase(),m=k(),v=t[_],w={...t};v?w[_]={...v,lastReviewedAt:m}:w[_]={count:0,lastReviewedAt:m,reviewedSources:[]},e(w),localStorage.setItem("wordData",JSON.stringify(w))},I=(N,_)=>{const m=k(),v=t[N];if(!v)return;const w=v.lastReviewedAt===m,C=v.reviewedSources||[],R=w&&C.length>0;if(w&&C.includes(_))return;const st=w?[...new Set([...C,_])]:[_],zt={...t,[N]:{count:R?v.count:v.count+1,lastReviewedAt:m,reviewedSources:st}};e(zt),localStorage.setItem("wordData",JSON.stringify(zt))},E=N=>{const _={...t};delete _[N],e(_),localStorage.setItem("wordData",JSON.stringify(_))},A=Object.entries(t).sort(([N,_],[m,v])=>{switch(o){case"abcAsc":return N.localeCompare(m);case"abcDesc":return m.localeCompare(N);case"countDesc":return v.count-_.count;default:return _.count-v.count}}),x=A.slice((u-1)*y,u*y),F=Math.ceil(A.length/y);return J.jsxs("div",{style:{padding:"1rem",fontFamily:"Arial",maxWidth:"700px",margin:"0 auto"},children:[J.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[J.jsxs("h1",{children:[S[f].title," (",S[f].totalWords(Object.keys(t).length),")"]}),J.jsx("button",{onClick:()=>{const N=f==="ko"?"en":"ko";g(N),localStorage.setItem("lang",N)},children:f==="ko"?"🇺🇸 English":"🇰🇷 한국어"})]}),J.jsxs("div",{children:[!i&&J.jsx("button",{onClick:()=>UP(oc,Ok).then(N=>s(N.user)),children:S[f].login}),i&&J.jsx("button",{onClick:async()=>{confirm("정말 로그아웃하시겠습니까?")&&(await vP(oc),s(null))},children:S[f].logout}),i&&J.jsxs(J.Fragment,{children:[J.jsx("button",{onClick:()=>PR(Tg(Hg,"users",i.uid),{wordData:t}).then(()=>alert(S[f].backupSuccess)),children:S[f].backup}),J.jsx("button",{onClick:async()=>{const N=await CR(Tg(Hg,"users",i.uid));N.exists()&&(e(N.data().wordData),localStorage.setItem("wordData",JSON.stringify(N.data().wordData)),alert("✅ 복원 완료! 새로고침하세요."))},children:S[f].restore}),J.jsxs("div",{children:["👋 ",i.displayName]})]})]}),J.jsxs("div",{style:{marginTop:"1rem"},children:[J.jsx("button",{onClick:()=>l(N=>N==="abcAsc"?"abcDesc":"abcAsc"),children:S[f].sortABC}),J.jsx("button",{onClick:()=>l(N=>N==="countAsc"?"countDesc":"countAsc"),children:S[f].sortCount})]}),F>1&&J.jsx($g,{page:u,totalPages:F,onPageChange:h,t:S[f]}),J.jsx("input",{type:"text",value:n,onChange:N=>r(N.target.value),onKeyDown:N=>{if(N.key==="Enter"){const _=n.trim().toLowerCase();_&&L(_),r("")}},placeholder:S[f].inputPlaceholder}),J.jsx("div",{children:x.map(([N,_])=>J.jsxs("div",{className:"word-card",children:[J.jsx("div",{className:"word-card-header",children:J.jsx("strong",{children:N})}),J.jsxs("div",{className:"word-card-sub",children:[J.jsx("div",{children:S[f].studies(_.count)}),J.jsxs("div",{className:"meta",children:[S[f].lastReviewedLabel,": ",S[f].lastStudied(V(_.lastReviewedAt))]})]}),J.jsxs("div",{children:[J.jsx("a",{href:`https://www.google.com/search?q=${N}+meaning`,target:"_blank",onClick:()=>I(N,"dictionary"),children:S[f].dictionary}),J.jsx("a",{href:`https://www.google.com/search?q=pronounce+${N}`,target:"_blank",onClick:()=>I(N,"pronunciation"),style:{marginLeft:"1rem"},children:S[f].pronunciation})]}),J.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginTop:"0.5rem"},children:[J.jsx("button",{onClick:()=>I(N,"complete"),children:S[f].studyDone}),J.jsx("button",{onClick:()=>{confirm(S[f].confirmDelete)&&E(N)},style:{color:"red"},children:S[f].delete})]})]},N))}),F>1&&J.jsx($g,{page:u,totalPages:F,onPageChange:h,t:S[f]}),J.jsx("div",{style:{marginTop:"2rem",fontSize:"0.8rem",color:"#888",textAlign:"center"},children:S[f].version("1.0.21")})]})}rv(document.getElementById("root")).render(J.jsx($t.StrictMode,{children:J.jsx(Lk,{})}));

 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi=G1;function pv(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:nh,automaticDataCollectionEnabled:!0},e),i=r.name;if(typeof i!="string"||!i)throw Yn.create("bad-app-name",{appName:String(i)});if(n||(n=lv()),!n)throw Yn.create("no-options");const s=rl.get(i);if(s){if(xr(n,s.options)&&xr(r,s.config))return s;throw Yn.create("duplicate-app",{appName:i})}const o=new i1(i);for(const u of rh.values())o.addComponent(u);const l=new J1(n,r,o);return rl.set(i,l),l}function mv(t=nh){const e=rl.get(t);if(!e&&t===nh&&lv())return pv();if(!e)throw Yn.create("no-app",{appName:t});return e}function Jn(t,e,n){var r;let i=(r=Q1[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const l=[`Unable to register library "${i}" with version "${e}":`];s&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),En.warn(l.join(" "));return}Pi(new Or(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lS(t){Pi(new Or("platform-logger",e=>new E1(e),"PRIVATE")),Pi(new Or("heartbeat",e=>new iS(e),"PRIVATE")),Jn(th,Sm,t),Jn(th,Sm,"esm2017"),Jn("fire-js","")}lS("");var uS="firebase",cS="11.8.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function W(t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,Sv(t,r,n)}function Sv(t,e,n){let r=`FIRESTORE (${ji}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;if(n!==void 0)try{r+=" CONTEXT: "+JSON.stringify(n)}catch{r+=" CONTEXT: "+n}throw wn(r),new Error(r)}function se(t,e,n,r){let i="Unexpected state";typeof n=="string"?i=n:r=n,t||Sv(e,i,r)}function Q(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WA{constructor(){this.sessionToken=je.EMPTY_BYTE_STRING}getSessionToken(e){return x.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,x.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JA{constructor(){this.Vs=!1,this.fs=!1,this.gs=100,this.ps=function(){return WI()?8:AS(Je())>0?6:4}()}initialize(e,n){this.ys=e,this.indexManager=n,this.Vs=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.ws(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Ss(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new YA;return this.bs(e,n,o).next(l=>{if(s.result=l,this.fs)return this.Ds(e,n,o,l.size)})}).next(()=>s.result)}Ds(e,n,r,i){return r.documentReadCount<this.gs?(Qr()<=Z.DEBUG&&j("QueryEngine","SDK will not create cache indexes for query:",Xr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.gs,"documents"),x.resolve()):(Qr()<=Z.DEBUG&&j("QueryEngine","Query:",Xr(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ps*i?(Qr()<=Z.DEBUG&&j("QueryEngine","The SDK decides to create cache indexes for query:",Xr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Kt(n))):x.resolve())}ws(e,n){if(Km(n))return x.resolve(null);let r=Kt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=ch(n,null,"F"),r=Kt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=ee(...s);return this.ys.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.vs(n,l);return this.Cs(n,h,o,u.readTime)?this.ws(e,ch(n,null,"F")):this.Fs(e,h,n,u)}))})))}Ss(e,n,r,i){return Km(n)||i.isEqual(G.min())?x.resolve(null):this.ys.getDocuments(e,r).next(s=>{const o=this.vs(n,s);return this.Cs(n,o,r,i)?x.resolve(null):(Qr()<=Z.DEBUG&&j("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Xr(n)),this.Fs(e,o,n,ES(i,Zs)).next(l=>l))})}vs(e,n){let r=new De(Wv(e));return n.forEach((i,s)=>{Hl(e,s)&&(r=r.add(s))}),r}Cs(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}bs(e,n,r){return Qr()<=Z.DEBUG&&j("QueryEngine","Using full collection scan to execute query:",Xr(n)),this.ys.getDocumentsMatchingQuery(e,n,rr.min(),r)}Fs(e,n,r,i){return this.ys.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zP="pendingRedirect",Na=new Map;class jP extends ww{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Na.get(this.auth._key());if(!e){try{const r=await BP(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Na.set(this.auth._key(),e)}return this.bypassAuthState||Na.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function BP(t,e){const n=WP(e),r=HP(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function $P(t,e){Na.set(t._key(),e)}function HP(t){return fn(t._redirectPersistence)}function WP(t){return ka(zP,t.config.apiKey,t.name)}async function qP(t,e,n=!1){if(Ot(t.app))return Promise.reject(Rr(t));const r=Yl(t),i=Ew(r,e),o=await new jP(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rk=5*60,Pk=uv("authIdTokenMaxAge")||Rk;let Bg=null;const kk=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Pk)return;const i=n==null?void 0:n.token;Bg!==i&&(Bg=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Nk(t=mv()){const e=vd(t,"auth");if(e.isInitialized())return e.getImmediate();const n=aP(t,{popupRedirectResolver:Ik,persistence:[OP,TP,mw]}),r=uv("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=kk(s.toString());yP(n,o,()=>o(n.currentUser)),gP(n,l=>o(l))}}const i=av("auth");return i&&uP(n,`http://${i}`),n}function Dk(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}rP({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=Ut("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",Dk().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ck("Browser");function $g({page:t,totalPages:e,onPageChange:n}){return ie.jsxs("div",{className:"pagination-controls",children:[ie.jsx("button",{onClick:()=>n(Math.max(1,t-1)),disabled:t===1,children:"⬅ 이전"}),ie.jsxs("span",{children:["페이지 ",t," / ",e]}),ie.jsx("button",{onClick:()=>n(Math.min(e,t+1)),disabled:t===e,children:"다음 ➡"})]})}const Vk={apiKey:"AIzaSyCS2cdIvwE8RuZXdAgCL-QE6tAYobYeixw",authDomain:"word-practice-app.firebaseapp.com",projectId:"word-practice-app",storageBucket:"word-practice-app.firebasestorage.app",messagingSenderId:"489669791875",appId:"1:489669791875:web:45291b0005ac5913068bb6"},xk=pv(Vk),Hg=hR(xk),oc=Nk(),Ok=new un;function Lk(){const[t,e]=an.useState({}),[n,r]=an.useState(""),[i,s]=an.useState(null),[o,l]=an.useState("countAsc"),[u,h]=an.useState(1),f=30;an.useEffect(()=>{const p=JSON.parse(localStorage.getItem("wordData"))||{};e(p),_P(oc,_=>s(_))},[]);const g=()=>new Date().toISOString().slice(0,10),y=p=>{const _=new Date,w=new Date(p),A=_.getTime()-w.getTime();return Math.floor(A/(1e3*60*60*24))},C=p=>{const _=p.toLowerCase(),w=g(),A=t[_],R={...t};A?R[_]={...A,lastReviewedAt:w}:R[_]={count:0,lastReviewedAt:w,reviewedSources:[]},e(R),localStorage.setItem("wordData",JSON.stringify(R))},k=(p,_)=>{const w=g(),A=t[p];if(!A)return;const R=A.lastReviewedAt===w,T=A.reviewedSources||[],st=R&&T.length>0;if(R&&T.includes(_))return;const dr=R?[...new Set([...T,_])]:[_],vt={...t,[p]:{count:st?A.count:A.count+1,lastReviewedAt:w,reviewedSources:dr}};e(vt),localStorage.setItem("wordData",JSON.stringify(vt))},D=p=>{const _={...t};delete _[p],e(_),localStorage.setItem("wordData",JSON.stringify(_))},O=async()=>{try{const p=await UP(oc,Ok);s(p.user)}catch(p){alert("로그인 실패: "+p.message)}},I=async()=>{confirm("정말 로그아웃하시겠습니까?")&&(await vP(oc),s(null))},v=async()=>{if(!i)return alert("로그인하세요.");await PR(Tg(Hg,"users",i.uid),{wordData:t}),alert("✅ 백업 완료!")},S=async()=>{if(!i)return alert("로그인하세요.");const p=await CR(Tg(Hg,"users",i.uid));p.exists()?(e(p.data().wordData),localStorage.setItem("wordData",JSON.stringify(p.data().wordData)),alert("✅ 복원 완료! 새로고침하세요.")):alert("❗ 저장된 데이터 없음")},V=p=>{l(_=>p==="abc"?_==="abcAsc"?"abcDesc":"abcAsc":_==="countAsc"?"countDesc":"countAsc")},U=Object.entries(t).sort(([p,_],[w,A])=>{switch(o){case"abcAsc":return p.localeCompare(w);case"abcDesc":return w.localeCompare(p);case"countDesc":return A.count-_.count;case"countAsc":default:return _.count-A.count}}),b=U.slice((u-1)*f,u*f),E=Math.ceil(U.length/f);return ie.jsxs("div",{style:{padding:"1rem",fontFamily:"Arial"},children:[ie.jsxs("h1",{children:["EchoWord (총 ",Object.keys(t).length,"단어)"]}),ie.jsxs("div",{children:[ie.jsx("button",{onClick:O,children:"🔑 로그인"}),ie.jsx("button",{onClick:v,children:"📤 백업"}),ie.jsx("button",{onClick:S,children:"📥 복원"}),ie.jsx("button",{onClick:I,children:"🚪 로그아웃"}),i&&ie.jsxs("div",{children:["👋 안녕하세요, ",i.displayName,"님!"]})]}),ie.jsxs("div",{style:{marginTop:"1rem"},children:[ie.jsx("button",{onClick:()=>V("abc"),children:"🔤 ABC 정렬"}),ie.jsx("button",{onClick:()=>V("count"),children:"🔢 복습횟수 정렬"})]}),E>1&&ie.jsx($g,{page:u,totalPages:E,onPageChange:h}),ie.jsx("input",{value:n,onChange:p=>r(p.target.value),onKeyDown:p=>{if(p.key==="Enter"){const _=n.trim().toLowerCase();_&&C(_),r("")}},placeholder:"Enter a word...",style:{width:"100%",padding:"0.5rem",marginTop:"1rem"}}),ie.jsx("div",{children:b.map(([p,_])=>ie.jsxs("div",{style:{background:"white",borderRadius:"10px",padding:"1rem",boxShadow:"0 2px 6px rgba(0,0,0,0.1)",marginTop:"1rem",color:"#222"},children:[ie.jsx("strong",{style:{fontSize:"1.2rem"},children:p})," (복습 횟수: ",_.count,")",ie.jsxs("div",{style:{fontSize:"0.85rem",color:"#666"},children:["마지막 복습일: ",y(_.lastReviewedAt)===0?"오늘":`+${y(_.lastReviewedAt)}일 전`]}),ie.jsxs("div",{children:[ie.jsx("a",{href:`https://www.google.com/search?q=${p}+meaning`,target:"_blank",onClick:()=>k(p,"dictionary"),children:"Dictionary"}),ie.jsx("a",{href:`https://www.google.com/search?q=pronounce+${p}`,target:"_blank",style:{marginLeft:"1rem"},onClick:()=>k(p,"pronunciation"),children:"Pronunciation"})]}),ie.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginTop:"0.5rem"},children:[ie.jsx("button",{onClick:()=>k(p,"complete"),children:"복습 완료"}),ie.jsx("button",{onClick:()=>D(p),style:{color:"red"},children:"삭제"})]})]},p))}),E>1&&ie.jsx($g,{page:u,totalPages:E,onPageChange:h}),ie.jsxs("div",{style:{marginTop:"2rem",fontSize:"0.8rem",color:"#888",textAlign:"center"},children:["Version: ","1.0.2"]})]})}rv(document.getElementById("root")).render(ie.jsx(an.StrictMode,{children:ie.jsx(Lk,{})}));
